...
async fn main() {
    ...
    let index_html_s = tokio::fs::read_to_string(opts.dir.join("index.html")).await.expect("Failed to read index.html");
    ...
    println!("You can view the website at http://localhost:{}", port);
